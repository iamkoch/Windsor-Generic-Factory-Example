...
This is a sample solution to support an upcoming blog post on http://iamkoch.com regarding anti-patterns and how one can attempt to remove Service Locator in certain situations.
